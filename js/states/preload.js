...
GumpleRush.Preload.prototype = {
  preload: function() {
    ...
    this.load.spritesheet("veronika", "assets/postavy/veronika.png", 11, 25);
    ...
    this.load.tilemap("gymplik", "assets/gumple/gymplik_one.json", null, Phaser.Tilemap.TILED_JSON);
